...
write.table(rlogMat.hgnc[n[c(1,(length(n)-6):length(n),2:(length(n)-7))]], file="/mnt/projects/iamp/results/qlucore/normalized-counts.deseq2.rlog.tsv", col.names=T, row.names=F, sep="\t", quote=F)
