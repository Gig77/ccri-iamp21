...
#---------------------
rld <- rlog(cds)
plot_heatmap(rld, "/mnt/projects/iamp/results/sample-dist.heatmap.deseq2.rlog.pdf")
plot_pca(rld, "/mnt/projects/iamp/results/sample-dist.pca.deseq2.rlog.pdf")
...
plot_heatmap(rld.21, "/mnt/projects/iamp/results/sample-dist.heatmap.chr21.deseq2.rlog.pdf")
plot_pca(rld.21, "/mnt/projects/iamp/results/sample-dist.pca.chr21.deseq2.rlog.pdf")
...
pdf("/mnt/projects/iamp/results/sample-dist.heatmap.let-7c.miR-99a.miR-125b.validated-targets.deseq2.rlog.pdf", width=8, height=12)
...
rownames(mat) <- ens2sym[match(rownames(mat), ens2sym$ensembl_gene_id), "hgnc_symbol"]
pdf("/mnt/projects/iamp/results/sample-dist.heatmap.let-7c.miR-99a.miR-125b.validated_plus_predicted-targets.deseq2.rlog.pdf", width=8, height=24)
...
plot_heatmap(rld.chr1, "/mnt/projects/iamp/results/sample-dist.heatmap.chr1.deseq2.rlog.pdf")
plot_pca(rld.chr1, "/mnt/projects/iamp/results/sample-dist.pca.chr1.deseq2.rlog.pdf")
