...
iAMP.vs.PC <- read.delim("/mnt/projects/iamp/results/deseq/iAMP-vs-PC.tsv", check.names=F, stringsAsFactors=F)
...
ER.vs.PC <- read.delim("/mnt/projects/iamp/results/deseq/ER-vs-PC.tsv", check.names=F, stringsAsFactors=F)
...
PC.vs.immature <- read.delim("/mnt/projects/iamp/results/deseq/PC-vs-immature.tsv", check.names=F, stringsAsFactors=F)
...
PC.vs.preB <- read.delim("/mnt/projects/iamp/results/deseq/PC-vs-preB.tsv", check.names=F, stringsAsFactors=F)
...
PC.vs.mature <- read.delim("/mnt/projects/iamp/results/deseq/PC-vs-mature.tsv", check.names=F, stringsAsFactors=F)
