...
iAMP.vs.ER.up <- read.delim(paste0("/mnt/projects/iamp/results/gsea/msigdb5/iAMP_vs_ER.gsea/", list.files(path="/mnt/projects/iamp/results/gsea/msigdb5/iAMP_vs_ER.gsea", pattern="gsea_report_for_na_pos.*xls")))
iAMP.vs.ER.down <- read.delim(paste0("/mnt/projects/iamp/results/gsea/msigdb5/iAMP_vs_ER.gsea/", list.files(path="/mnt/projects/iamp/results/gsea/msigdb5/iAMP_vs_ER.gsea", pattern="gsea_report_for_na_neg.*xls")))
iAMP.vs.DS.up <- read.delim(paste0("/mnt/projects/iamp/results/gsea/msigdb5/iAMP_vs_DS.gsea/", list.files(path="/mnt/projects/iamp/results/gsea/msigdb5/iAMP_vs_DS.gsea", pattern="gsea_report_for_na_pos.*xls")))
iAMP.vs.DS.down <- read.delim(paste0("/mnt/projects/iamp/results/gsea/msigdb5/iAMP_vs_DS.gsea/", list.files(path="/mnt/projects/iamp/results/gsea/msigdb5/iAMP_vs_DS.gsea", pattern="gsea_report_for_na_neg.*xls")))
ER.vs.DS.up <- read.delim(paste0("/mnt/projects/iamp/results/gsea/msigdb5/ER_vs_DS.gsea/", list.files(path="/mnt/projects/iamp/results/gsea/msigdb5/ER_vs_DS.gsea", pattern="gsea_report_for_na_pos.*xls")))
ER.vs.DS.down <- read.delim(paste0("/mnt/projects/iamp/results/gsea/msigdb5/ER_vs_DS.gsea/", list.files(path="/mnt/projects/iamp/results/gsea/msigdb5/ER_vs_DS.gsea", pattern="gsea_report_for_na_neg.*xls")))
iAMP.vs.immature.up <- read.delim(paste0("/mnt/projects/iamp/results/gsea/msigdb5/iAMP_vs_immature.gsea/", list.files(path="/mnt/projects/iamp/results/gsea/msigdb5/iAMP_vs_immature.gsea", pattern="gsea_report_for_na_pos.*xls")))
iAMP.vs.immature.down <- read.delim(paste0("/mnt/projects/iamp/results/gsea/msigdb5/iAMP_vs_immature.gsea/", list.files(path="/mnt/projects/iamp/results/gsea/msigdb5/iAMP_vs_immature.gsea", pattern="gsea_report_for_na_neg.*xls")))
DS.vs.immature.up <- read.delim(paste0("/mnt/projects/iamp/results/gsea/msigdb5/DS_vs_immature.gsea/", list.files(path="/mnt/projects/iamp/results/gsea/msigdb5/DS_vs_immature.gsea", pattern="gsea_report_for_na_pos.*xls")))
DS.vs.immature.down <- read.delim(paste0("/mnt/projects/iamp/results/gsea/msigdb5/DS_vs_immature.gsea/", list.files(path="/mnt/projects/iamp/results/gsea/msigdb5/DS_vs_immature.gsea", pattern="gsea_report_for_na_neg.*xls")))
ER.vs.immature.up <- read.delim(paste0("/mnt/projects/iamp/results/gsea/msigdb5/ER_vs_immature.gsea/", list.files(path="/mnt/projects/iamp/results/gsea/msigdb5/ER_vs_immature.gsea", pattern="gsea_report_for_na_pos.*xls")))
ER.vs.immature.down <- read.delim(paste0("/mnt/projects/iamp/results/gsea/msigdb5/ER_vs_immature.gsea/", list.files(path="/mnt/projects/iamp/results/gsea/msigdb5/ER_vs_immature.gsea", pattern="gsea_report_for_na_neg.*xls")))
iAMP.vs.preB.up <- read.delim(paste0("/mnt/projects/iamp/results/gsea/msigdb5/iAMP_vs_preB.gsea/", list.files(path="/mnt/projects/iamp/results/gsea/msigdb5/iAMP_vs_preB.gsea", pattern="gsea_report_for_na_pos.*xls")))
iAMP.vs.preB.down <- read.delim(paste0("/mnt/projects/iamp/results/gsea/msigdb5/iAMP_vs_preB.gsea/", list.files(path="/mnt/projects/iamp/results/gsea/msigdb5/iAMP_vs_preB.gsea", pattern="gsea_report_for_na_neg.*xls")))
DS.vs.preB.up <- read.delim(paste0("/mnt/projects/iamp/results/gsea/msigdb5/DS_vs_preB.gsea/", list.files(path="/mnt/projects/iamp/results/gsea/msigdb5/DS_vs_preB.gsea", pattern="gsea_report_for_na_pos.*xls")))
DS.vs.preB.down <- read.delim(paste0("/mnt/projects/iamp/results/gsea/msigdb5/DS_vs_preB.gsea/", list.files(path="/mnt/projects/iamp/results/gsea/msigdb5/DS_vs_preB.gsea", pattern="gsea_report_for_na_neg.*xls")))
ER.vs.preB.up <- read.delim(paste0("/mnt/projects/iamp/results/gsea/msigdb5/ER_vs_preB.gsea/", list.files(path="/mnt/projects/iamp/results/gsea/msigdb5/ER_vs_preB.gsea", pattern="gsea_report_for_na_pos.*xls")))
ER.vs.preB.down <- read.delim(paste0("/mnt/projects/iamp/results/gsea/msigdb5/ER_vs_preB.gsea/", list.files(path="/mnt/projects/iamp/results/gsea/msigdb5/ER_vs_preB.gsea", pattern="gsea_report_for_na_neg.*xls")))
iAMP.vs.mature.up <- read.delim(paste0("/mnt/projects/iamp/results/gsea/msigdb5/iAMP_vs_mature.gsea/", list.files(path="/mnt/projects/iamp/results/gsea/msigdb5/iAMP_vs_mature.gsea", pattern="gsea_report_for_na_pos.*xls")))
iAMP.vs.mature.down <- read.delim(paste0("/mnt/projects/iamp/results/gsea/msigdb5/iAMP_vs_mature.gsea/", list.files(path="/mnt/projects/iamp/results/gsea/msigdb5/iAMP_vs_mature.gsea", pattern="gsea_report_for_na_neg.*xls")))
DS.vs.mature.up <- read.delim(paste0("/mnt/projects/iamp/results/gsea/msigdb5/DS_vs_mature.gsea/", list.files(path="/mnt/projects/iamp/results/gsea/msigdb5/DS_vs_mature.gsea", pattern="gsea_report_for_na_pos.*xls")))
DS.vs.mature.down <- read.delim(paste0("/mnt/projects/iamp/results/gsea/msigdb5/DS_vs_mature.gsea/", list.files(path="/mnt/projects/iamp/results/gsea/msigdb5/DS_vs_mature.gsea", pattern="gsea_report_for_na_neg.*xls")))
ER.vs.mature.up <- read.delim(paste0("/mnt/projects/iamp/results/gsea/msigdb5/ER_vs_mature.gsea/", list.files(path="/mnt/projects/iamp/results/gsea/msigdb5/ER_vs_mature.gsea", pattern="gsea_report_for_na_pos.*xls")))
ER.vs.mature.down <- read.delim(paste0("/mnt/projects/iamp/results/gsea/msigdb5/ER_vs_mature.gsea/", list.files(path="/mnt/projects/iamp/results/gsea/msigdb5/ER_vs_mature.gsea", pattern="gsea_report_for_na_neg.*xls")))
...
cols.values <- c("iAMP.vs.ER", "iAMP.vs.DS", "ER.vs.DS", "iAMP.vs.immature", "DS.vs.immature", "ER.vs.immature", "iAMP.vs.preB", "DS.vs.preB", "ER.vs.preB", "iAMP.vs.mature", "DS.vs.mature", "ER.vs.mature")

plot.heatmap <- function(data, cexCol=0.9, cexRow=0.9, sigLevel=0.02, hsigLevel=1e-5, minNES=NA, title="") {
	if (!is.na(minNES)) {
		nes.best <- apply(data[,c("iAMP.vs.ER", "iAMP.vs.DS", "ER.vs.DS", "iAMP.vs.immature", "DS.vs.immature", "ER.vs.immature", "iAMP.vs.preB", "DS.vs.preB", "ER.vs.preB", "iAMP.vs.mature", "DS.vs.mature", "ER.vs.mature")], 1, function (x) { max(abs(x))} )
		data <- data[nes.best >= minNES,]
	}
	data <- data[data$FDR.best<sigLevel,cols.values]
	hmcol <- colorRampPalette(brewer.pal(10, "RdBu"))(256)
	fdrs <- as.matrix(merged[rownames(data),c("FDR.q.val.iAMP.vs.ER", "FDR.q.val.iAMP.vs.DS", "FDR.q.val.ER.vs.DS", "FDR.q.val.iAMP.vs.immature", "FDR.q.val.DS.vs.immature", "FDR.q.val.ER.vs.immature", "FDR.q.val.iAMP.vs.preB", "FDR.q.val.DS.vs.preB", "FDR.q.val.ER.vs.preB", "FDR.q.val.iAMP.vs.mature", "FDR.q.val.DS.vs.mature", "FDR.q.val.ER.vs.mature")])
	sig <- fdrs ; sig[,] <- NA
	...
	heatmap.2(as.matrix(data), Colv=F, Rowv=T, dendrogram="row", trace="none", col=rev(hmcol), margin=c(10, 25), cexCol=cexCol, cexRow=cexRow, keysize=0.7, 
			  ...
			  main=sprintf("%s\n(* FDR <= %.4g, ** FDR <= %.4g)", title, sigLevel, hsigLevel),
			  key.title="NES")
...
genesets <- geneset
plot.heatmap(merged[geneset,], cexRow=0.7, sigLevel=0.001, hsigLevel=1e-15, title="MSigDB 5.0 Pathways")
dev.off()

# UP
pdf("/mnt/projects/iamp/results/gsea/msigdb5/gsea-heatmap.up.pdf", height=15, width=10)
geneset <- grep("_UP$", rownames(merged), perl=T, value=TRUE)
genesets <- c(genesets, geneset)
plot.heatmap(merged[geneset,], cexRow=0.5, sigLevel=0.001, hsigLevel=1e-20, minNES=7, title="MSigDB 5.0 UP-Genesets")
dev.off()

# DOWN
pdf("/mnt/projects/iamp/results/gsea/msigdb5/gsea-heatmap.dn.pdf", height=15, width=10)
geneset <- grep("_DN$", rownames(merged), perl=T, value=TRUE)
genesets <- c(genesets, geneset)
plot.heatmap(merged[geneset,], cexRow=0.5, sigLevel=0.001, hsigLevel=1e-20, minNES=7, title="MSigDB 5.0 DOWN-Genesets")
dev.off()
...
genesets <- c(genesets, geneset)
plot.heatmap(merged[geneset,], sigLevel=0.1, hsigLevel=1e-10, title="MSigDB 5.0 MiR Targets")
dev.off()
...
genesets <- c(genesets, geneset)
plot.heatmap(merged[geneset,], title="Chromosome Location", sigLevel=1e-2, hsigLevel=1e-8)
dev.off()
...
genesets <- c(genesets, geneset)
plot.heatmap(merged[geneset,], cexRow=0.5, sigLevel=0.01, title="MSigDB 5.0 Promoter Motif")
dev.off()
...
genesets <- c(genesets, geneset)
plot.heatmap(merged[geneset,], cexRow=0.5, sigLevel=1e-10, hsigLevel=1e-100, title="MSigDB 5.0 Cancer Gene Neighborhoods")
dev.off()
...
plot.heatmap(merged[geneset,], cexRow=0.7, sigLevel=1e-4, hsigLevel=1e-30, title="MSigDB 5.0 Other Gene Sets")
dev.off()
